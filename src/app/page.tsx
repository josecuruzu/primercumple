    ...
    >
      ...
      <div className="fixed bottom-0 left-0 right-0 pointer-events-none z-10">
        ...
        <div className="absolute bottom-0" style={{ left: '4px' }}>
          <Plant src="/plants/alga_teal.png" alt="alga teal" width={70} height={67} className="alga-wave" style={{ width: '70px' }} />
        </div>
        <div className="absolute bottom-0" style={{ right: '4px' }}>
          <Plant src="/plants/alga_teal.png" alt="alga teal" width={70} height={67} className="alga-wave-r" style={{ width: '70px' }} />
        </div>

        <div className="absolute bottom-0" style={{ left: '18%' }}>
          <Plant src="/plants/alga_verde.png" alt="alga verde" width={78} height={86} className="alga-wave-delay" style={{ width: '78px' }} />
        </div>
        <div className="absolute bottom-0" style={{ right: '18%' }}>
          <Plant src="/plants/alga_verde.png" alt="alga verde" width={78} height={86} className="alga-wave-r" style={{ width: '78px', animationDelay: '1s' }} />
        </div>

        <div className="absolute bottom-0" style={{ left: '8%' }}>
          <Plant src="/plants/coral_pink.png" alt="coral rosa" width={90} height={84} className="coral-bob" style={{ width: '90px' }} />
        </div>
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2">
          <Plant src="/plants/coral_teal.png" alt="coral teal" width={100} height={95} className="coral-bob-delay" style={{ width: '100px' }} />
        </div>
        <div className="absolute bottom-0" style={{ right: '8%' }}>
          <Plant src="/plants/coral_purple.png" alt="coral violeta" width={88} height={78} className="coral-bob-r" style={{ width: '88px' }} />
        </div>
      ...
      <header className="relative pt-12 pb-6 px-4 text-center z-20">
        ...
        >
          ...
          >
            <defs>
              <path id="curvePath" d="M 20,100 Q 250,10 480,100" fill="none" />
            </defs>
            <text fill="#6ec6d8" className="font-sniglet font-extrabold" style={{ fontSize: '44px' }}>
